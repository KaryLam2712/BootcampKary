public class DemoPrimitive {
    ...
    long l2 = 9223372036854775807L; // L means a way to specify this value is a long value
    ...
    // 3. In conclude, you cannot a higher level of data value to a lower level data type
    double d10 = 10.2;
